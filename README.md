...
🎸이기연
<br>
이번 프로젝트에서 Vue.js와 Springboot를 사용하여 기존 Tempository 서비스를 웹 페이지로 구현해보았다. 
...
처음에는 사용 방법과 목적을 이해하기가 어려웠지만, 시간이 흐를수록 점점 더 익숙해지고 숙련도가 늘고 있다는 느낌을 받았습니다. Vue.js를 활용하면서 중첩 라우팅을 통한 페이지 출력을 해보았으며, 프론트 엔드에서 백엔드의 데이터 통신이 어떻게 이루어 지는 지 알 수 있었습니다. 그리고, axios를 이용하여 api를 불러오는 과정에서의 CORS문제가 발생하였고, 백엔드 부분에 WebConfig와 프론트엔드의 Viteconfig 설정을 함으로써, CORS 문제를 해결한 후 데이터를 받아와, 효과적으로 화면에 표시할 수 있었습니다. 

이번 프로젝트를 통해 짧은 프론트엔드 수업과 프로젝트 기간이었지만, HTML, CSS, JavaScript 및 Vue.js의 기초를 다져나갈 수 있는 시간이었습니다. 또한 백엔드와 프론트엔드 간의 소통 방식에 대한 이해도 향상되었습니다. 앞으로의 프로젝트에서도 발전된 모습을 보여드릴 수 있도록 노력하겠습니다.
<br>
</details>
